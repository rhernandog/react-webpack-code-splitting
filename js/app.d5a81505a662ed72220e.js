...
var Header = function Header(props) {
	...
	return _react2.default.createElement(
		...
		_react2.default.createElement(CreateLink, { path: pathname, to: process.env.PUBLIC_URL + "/", text: "Home" }),
		_react2.default.createElement(CreateLink, { path: pathname, to: process.env.PUBLIC_URL + "/services", text: "services" }),
		_react2.default.createElement(CreateLink, { path: pathname, to: process.env.PUBLIC_URL + "/images", text: "Images" }),
		_react2.default.createElement(CreateLink, { path: pathname, to: process.env.PUBLIC_URL + "/contact", text: "contact" }),
...
//# sourceMappingURL=app.d5a81505a662ed72220e.js.map