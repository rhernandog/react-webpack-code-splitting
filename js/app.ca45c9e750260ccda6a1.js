...
var Header = function Header(props) {
	...
	return _react2.default.createElement(
		...
		_react2.default.createElement(CreateLink, { path: pathname, to: "/", text: "Home" }),
		_react2.default.createElement(CreateLink, { path: pathname, to: "/services", text: "services" }),
		_react2.default.createElement(CreateLink, { path: pathname, to: "/images", text: "Images" }),
		_react2.default.createElement(CreateLink, { path: pathname, to: "/contact", text: "contact" }),
...
//# sourceMappingURL=app.ca45c9e750260ccda6a1.js.map